...
/**
 * Created by Comp on 7/5/2017.
 */

public class ShowCommonPayable extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_showcommonpayable, container, false);
    }
    ...
    void showExpenseList() {
        try {
            ...
            postRequest(postUrl + "/getcommonexpense", userInfo.toString());
        } catch (Exception ex) {
                ...
                try {
                    ...
                    if (s != null) {
                        if (resPonse.length() > 0) {
                            ...
                            {
                                Toast.makeText(getContext(), "No common payable added.", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            ...
                            for (int nIndex = 0; nIndex < jsonArray.length(); nIndex++) {
                                ...
                                unbilledAmount.setText("Total common payable - " + fUnbilledamount);
                            }
                        } else {
                            Toast.makeText(getContext(), "No common payable added yet !!!", Toast.LENGTH_SHORT).show();
                        }
                    }
